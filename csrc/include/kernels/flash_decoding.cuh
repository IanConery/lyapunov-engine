...
struct FlashDecodingParams {
  ...
  void *mid_out_ptr;  // Workspace for partial outputs [batch_size, num_heads,
                      // num_partitions, head_dim]
  float *mid_lse_ptr; // Workspace for partial LSE [batch_size, num_heads,
                      // num_partitions]
